...
const CUSTOM_ART = {
  ...
  22: 'assets/art/slot-22.png',
  23: 'assets/art/slot-23.png',
  24: 'assets/art/slot-24.png',
  25: 'assets/art/slot-25.png',
  26: 'assets/art/slot-26.png',
  27: 'assets/art/slot-27.png',
  28: 'assets/art/slot-28.png',
  29: 'assets/art/slot-29.png',
...
const MONSTER_INFO = {
  ...
  22: { name:'ロウソッコ',     desc:'火をともしたばかりの小さなロウソク。まだ どんな姿になるかわからない。' },
  23: { name:'チビドラゴ',     desc:'生まれたての小さなドラゴン。ほっぺが赤くて、まだ火は吐けない。' },
  24: { name:'ヒノコブタ',     desc:'炎につつまれたイノシシの子。もえるごみのにおいに さそわれて出てくる。' },
  25: { name:'シャンデリオン', desc:'三つの炎をともす、ロウソクの王さま。資源を大切にした子のところに あらわれる。', rarity:4 },
  26: { name:'ロウソクネコ',   desc:'あたまにロウソクをのせたネコ。夜道を いっしょに歩いてくれる。', rarity:2 },
  27: { name:'ホノオドラゴン', desc:'するどい角と大きな翼をもつ、炎のドラゴン。きちんと分別した子だけが出会える。', rarity:4 },
  28: { name:'アカドラゴ',     desc:'小さな翼でぱたぱた飛ぶ、赤いドラゴン。げんきいっぱい。', rarity:2 },
  29: { name:'イノシシキング', desc:'こん棒とよろいを身につけた イノシシの戦士。もえるごみを へらす力もち。', rarity:3 },
  30: { name:'ヒノシシ',       desc:'背中に炎をまとったイノシシ。もやすごみが多いと あらわれる。', rarity:1 },
  // ---- ハズレ ----
