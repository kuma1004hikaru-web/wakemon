...
const CONTENT_I18N = {
  ...
  hira: {
    ...
    mon: {
      ...
      22:{ desc:'ちいさな ひを ともす ほのおの こ。' },
      23:{ desc:'もえた あとの すみから うまれた。まだ ほんのり あたたかい。' },
      24:{ desc:'もやした ごみの けむりから うまれた。ごみを へらすと きえていく。' },
      25:{ desc:'ねつを エネルギーに かえて うまれかわる とり。' },
      26:{ desc:'はいが かたまって できた いわの からだ。ちからもちで たよりになる。' },
      27:{ desc:'しっぽの ひで みんなを てらす ネコ。' },
      28:{ desc:'おなかが ストーブに なっている クマ。ふゆは みんなが あつまってくる。' },
      29:{ desc:'はいを まきちらしながら とぶ とり。' },
      30:{ desc:'けむりで そらを よごしてしまう ドラゴン。ごみを へらすと おとなしくなる。' },
  ...
  en: {
    ...
    mon: {
      ...
      22:{ name:'Sparklet', desc:'A little flame child that lights a small fire.' },
      23:{ name:'Charby', desc:'Born from charcoal left after burning. Still faintly warm.' },
      24:{ name:'Smokelet', desc:'Born from the smoke of burned trash. It fades away as trash decreases.' },
      25:{ name:'Phoenix', desc:'A bird that turns heat into energy and is reborn. It can turn trash into resources.' },
      26:{ name:'Magma Golem', desc:'A rock body formed from hardened ash. Strong and dependable.' },
      27:{ name:'Torch Cat', desc:'A cat that lights the way with the flame on its tail. Skilled with fire.' },
      28:{ name:'Stove Bear', desc:'A bear with a stove for a belly. In winter everyone gathers around.' },
      29:{ name:'Ash Bird', desc:'A bird that scatters ash as it flies. It appears when there is a lot of burnable trash.' },
      30:{ name:'Smog Dragon', desc:'A dragon that dirties the sky with smoke. Reduce trash and it calms down.' },
  ...
  zh: {
    ...
    mon: {
      ...
      22:{ name:'小火苗', desc:'点起小小火焰的火之子。' },
      23:{ name:'炭炭', desc:'从燃烧后的木炭中诞生。还有一点点温暖。' },
      24:{ name:'烟宝', desc:'从焚烧垃圾的烟中诞生。垃圾减少它就会消失。' },
      25:{ name:'凤凰', desc:'把热变成能量、浴火重生的鸟。拥有把垃圾变成资源的力量。' },
      26:{ name:'岩浆魔像', desc:'由灰烬凝固而成的岩石身体。力气大又可靠。' },
      27:{ name:'火把猫', desc:'用尾巴的火照亮大家的猫。很会用火。' },
      28:{ name:'暖炉熊', desc:'肚子是暖炉的熊。冬天大家都会聚过来。' },
      29:{ name:'吹灰鸟', desc:'一边飞一边撒灰的鸟。可燃垃圾多的时候就会出现。' },
      30:{ name:'雾霾龙', desc:'用烟把天空弄脏的龙。减少垃圾它就会安静下来。' },
  ...
  ko: {
    ...
    mon: {
      ...
      22:{ name:'불씨', desc:'작은 불을 밝히는 불꽃의 아이.' },
      23:{ name:'숯이', desc:'타고 남은 숯에서 태어났어요. 아직 은은하게 따뜻해요.' },
      24:{ name:'연기아이', desc:'태운 쓰레기의 연기에서 태어났어요. 쓰레기를 줄이면 사라져요.' },
      25:{ name:'피닉스', desc:'열을 에너지로 바꿔 다시 태어나는 새. 쓰레기를 자원으로 만드는 힘이 있어요.' },
      26:{ name:'마그마 골렘', desc:'재가 굳어서 생긴 바위 몸. 힘이 세고 든든해요.' },
      27:{ name:'횃불 고양이', desc:'꼬리의 불로 모두를 비추는 고양이. 불을 잘 다뤄요.' },
      28:{ name:'난로 곰', desc:'배가 난로인 곰. 겨울에는 모두가 모여들어요.' },
      29:{ name:'재날림새', desc:'재를 흩뿌리며 나는 새. 타는 쓰레기가 많으면 나타나요.' },
      30:{ name:'스모그 드래곤', desc:'연기로 하늘을 더럽히는 드래곤. 쓰레기를 줄이면 얌전해져요.' },
